...
/***/ function(module, exports, __webpack_require__) {
	...
	const TweenMax = __webpack_require__(1);
	function swipeRight(evupApp, evupCards) {
	    ...
	    const temp = evupCards[0].cloneNode(true);
	    temp.classList.remove('evup-card-2');
	    window.setTimeout(() => {
	...
	ready(() => {
	    ...
	    setTimeout(() => {
	        ...
	        timeline(evupCards[2]).to('evup-card-show', 0).to('evup-card-back', 1000).to('evup-card-exit', 1000);
	        let x = false;
	        setInterval(() => {
	            if (x) {
	                ...
	                evupCards[2].classList.add('evup-card-show');
	                setTimeout(() => {
	                    evupCards[2].classList.add('evup-card-back');
	                    setTimeout(() => {
	                        evupCards[2].classList.add('evup-card-exit');
	                    }, 1000);
	                }, 1000);
	...
	/*
	   setTimeout(function(){
	   TweenMax.to('.evup-card', 1, {
	   x: "300px", ease: SlowMo.ease.config(0.2, 0.7)
	   });
	   }, 1000);
	   */
	function ready(fn) {
	...
	function swipeRight(evupApp, evupCards) {
	  ...
	  var temp = evupCards[0].cloneNode(true);
	  temp.classList.remove('evup-card-2');
	...
	ready(function() {
	  var evupApp = document.querySelectorAll('.evup-app')[0];
	  var evupCards = document.querySelectorAll('.evup-card');
	  evupCards = toArray(evupCards);
	  setTimeout(function() {
	    var el;
	    evupCards.forEach(function (el, i) {
	      i++;
	      el.classList.add('evup-card-' + i);
	    });
	    timeline(evupCards[2])
	      .to('evup-card-show', 0)
	      .to('evup-card-back', 1000)
	      .to('evup-card-exit', 1000)
